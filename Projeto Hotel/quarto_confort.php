...
<body>
  ...
  <div class="tela">
    ...
    <div class="nomequarto">
      <h1>Quarto Confort</h1>
      <p>O melhor custo beneficio</p>
      <a href="formulario.php?tipo=Confort" class="btn-comprar">Comprar Quarto</a>
    </div>

    <div class="descricao">
      <h1>Descrição</h1>
        <p><h1 id="item_nome">Capacidade:</h1> até 2 pessoas</p>
        <p><h1 id="item_nome">Valor:</h1> 250 por noite</p>
        <p><h1 id="item_nome">Ideal para:</h1> Casais, viagens curtas</p>
    </div>

    <div class="caracteristica">
      <h1>Caracteristicas</h1>
      <p>- Cama queen size</p>
<p>- Banheiro privativo com chuveiro</p>
<p>- Wi-Fi gratuito</p>
<p>- Televisão de tela plana</p>
<p>- Ar-condicionado</p>
<p>- Escrivaninha para trabalho ou estudo</p>
<p>- Serviço de quarto disponível</p>
