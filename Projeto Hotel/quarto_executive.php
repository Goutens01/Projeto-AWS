...
<body>
  ...
  <div class="tela">
    ...
    <div class="nomequarto">
      <h1>Quarto Executive</h1>
      <p>O equilibrio entre dois mundos</p>
      <a href="formulario.php?tipo=Executive" class="btn-comprar">Comprar Quarto</a>
    </div>

    <div class="descricao">
      <h1>Descrição</h1>
        <p><h1 id="item_nome">Capacidade:</h1> até 3 pessoas</p>
        <p><h1 id="item_nome">Valor:</h1> 250 por noite</p>
        <p><h1 id="item_nome">Ideal para:</h1> Estadias longas, executivos e familias pequenas</p>
    </div>

    <div class="caracteristica">
      <h1>Caracteristicas</h1>
      <p>- Cama king size</p>
<p>- Banheiro privativo com banheira e chuveiro</p>
<p>- Wi-Fi de alta velocidade</p>
<p>- Smart TV com canais a cabo</p>
<p>- Ar-condicionado com controle individual</p>
<p>- Minibar abastecido</p>
<p>- Cofre para itens pessoais</p>
<p>- Mesa de trabalho com cadeira ergonômica</p>
<p>- Roupas de cama premium</p>
    </div>
